...
import (
	apple "github.com/iooojik/go-auth-gate/pkg/apple"
...
func (_c *ClientSecretGenerator_Execute_Call) Return(_a0 string, _a1 error) *ClientSecretGenerator_Execute_Call {
...
func NewClientSecretGenerator(t interface {
	mock.TestingT
	Cleanup(func())
